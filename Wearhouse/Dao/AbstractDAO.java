...
public class AbstractDAO<T>{
	...
	//Metoda care interogeaza tabele, care va returna toate inregistrarile facute, returneaza astfel o lista de obiecte 
	...
	public JTable newTable(List<Object> list)
	{
		...
		{for(int j=0;j<fields.length;j++)
			{
				try{
					data[i][j]=fields[j].get(list.get(i));
				}catch(IllegalArgumentException e){
					e.printStackTrace();
				}catch(IllegalAccessException e){
					e.printStackTrace();
